 ...
 * @author tkola
 */
public class Subtraction extends RuleOperator {
...
//                    .append(" of column ").append(columnName).append(" minus ");
            str.append(itemCode).append(" [ ").append(columnName).append(" ] ").append(" minus ");
...
//                    result.append(str.toString());
    ...
    private AssertionRuleCompVO generateInfo4dynamic(String returnCode, int order, HBoxGenerator anchorPaneHBoxGenerator, boolean isrhs, boolean islast, boolean isInter) {
        ...
        String columnName = columnandTypeVO.getColumnName().replace("|", "-");
        try {
           // str.append("Total value of column ").append(columnName).append(" minus ");
            str.append("sum of Field [").append(columnName).append("]").append(" minus ");
            if (order == 1) {
                msg.append(str.toString());
