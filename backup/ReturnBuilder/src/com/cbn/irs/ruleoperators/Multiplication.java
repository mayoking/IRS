 ...
 * @author tkola
 */
public class Multiplication extends RuleOperator {
...
//                    .append(" of column ").append(columnName).append(" multiply by ");
            str.append(itemCode).append(" [ ").append(columnName).append(" ] ").append(" multiply by ");
