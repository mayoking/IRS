...
import com.bbt.irs.ui.HBoxGenerator4MaxOperator;
 ...
 * @author tkola
 */
public class MaxController extends ComplexUIController implements Initializable{
   ...
   String workColCode;
    ...
    public void generateInitialUI4ComplexOperator(String worKCollcode, String returnCode) {
        ...
        HBoxGenerator hboxGenerator = new HBoxGenerator4MaxOperator(lastYLayout, reqvo);
    ...
    public void submitaction(ActionEvent e) {
        ...
        if (!isInter) {
             assertion = "max(" + String.format(itemCodecolPlaceHolder, colunName.getColumnName()) + ")";
        } else {
             assertion = "max(" + String.format(interItemCodeColPlaceHolder,returnCode, colunName.getColumnName()) + ")";
        }
        String message = "maxium value of field[" + colunName.getColumnName() + "]";
