...
import com.bbt.irs.ui.HBoxGenerator4AvgOperator;
 ...
 * @author tkola
 */
public class AverageController extends ComplexUIController implements Initializable {
    ...
    public void generateInitialUI4ComplexOperator(String worKCollcode, String returnCode) {
        ...
        HBoxGenerator hboxGenerator = new HBoxGenerator4AvgOperator(lastYLayout, reqvo);
    ...
    public void submitaction(ActionEvent e) {
        ...
        if (!isInter) {
             assertion = "avg(" + String.format(itemCodecolPlaceHolder, colunName.getColumnName()) + ")";
        } else {
             assertion = "avg(" + String.format(interItemCodeColPlaceHolder,returnCode, colunName.getColumnName()) + ")";
        }
        String message = "average of field[" + colunName.getColumnName() + "]";
