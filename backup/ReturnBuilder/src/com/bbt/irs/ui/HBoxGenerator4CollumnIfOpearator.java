 ...
 * @author tkola
 */
public class HBoxGenerator4CollumnIfOpearator extends HBoxGenerator4Ifoperator {

    public HBoxGenerator4CollumnIfOpearator(double lastYLayout, RequestVO requestVO) {
