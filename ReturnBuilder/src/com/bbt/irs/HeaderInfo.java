...
import static com.bbt.irs.ErrorNameDesc.FIELD_BLANK;
import static com.bbt.irs.ErrorNameDesc.NON_EXIST_CONTAINER;
import static com.bbt.irs.Messages.CELLNOID;
 ...
 * @author opeyemi
 */
public class HeaderInfo implements Messages {
        ...
        btn2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    Logger.getLogger(HeaderInfo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    public boolean validateHeaderInfo() {
        ...
        if (vb == null) {
            Utility.showDialog(NON_EXIST_CONTAINER, true);
            return false;
        }
    ...
    private boolean checkControl(TextField field1, TextField field2, ComboBox combo1, ComboBox combo2) {
        ...
        if (field1.getText().isEmpty()) {
            Utility.showDialog("Cell Number", FIELD_BLANK, true);
            return false;
        ...
        if (combo1 == null || combo1.getSelectionModel() == null || combo1.getSelectionModel().getSelectedItem() == null) {
            Utility.showDialog("Data Type", FIELD_BLANK, true);
        ...
        if (field2.getText().isEmpty()) {
            Utility.showDialog("Cell Name", FIELD_BLANK, true);
            return false;

        }

        if (combo2 == null || combo2.getSelectionModel() == null || combo2.getSelectionModel().getSelectedItem() == null) {
            Utility.showDialog("Data Size", FIELD_BLANK, true);
            return false;
        }
    ...
    public void readXLS() {
        try {
            ...
            LOGGER.log(org.apache.logging.log4j.Level.FATAL, "readXLS failed", ex);
        }
    }
    ...
    //public final static LinkedHashMap<Integer,LinkedList<HeaderInfoVO>> allHeaderInfo = new LinkedHashMap();
