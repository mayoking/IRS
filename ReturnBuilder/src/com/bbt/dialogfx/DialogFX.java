...
/**
 *
 * @author Mark Heckler (mark.heckler@gmail.com, @HecklerMark), Rafael Nunes
 * (rafaelnunes737@hotmail.com, @rafaellnunees)
 */
public final class DialogFX {
     ...
     */
    public enum Type {
        ACCEPT, ERROR, WARNING, INFO, QUESTION
    };
    ...
    /* Getters */
    public final static String getDialogFXVersion() {
        return MAJOR_VERSION + "." + MINOR_VERSION;
    }

    /**
     * Default constructor for a DialogFX dialog box. Creates an INFO box by
     * default.
     *
     * @see Type
     */
    ...
    private void populateStage() {
       String iconFile = "dialog-question.png";
  if (counter < 1){
        switch (type) {
            case ACCEPT:
        ...
        if (popUp.getScene() == null) {
            Scene scenes = new Scene(popUp);
            stage.setScene(scenes);
        }
        else {

            
            stage.setScene(popUp.getScene());
            //Scene scenes = new Scene(popUp);
            //stage.setScene(scenes);
        }
